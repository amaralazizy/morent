...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        IconLeft: ({ className, ...props }: { className?: string, props: React.ComponentProps<typeof ChevronLeft> }) => (
          <ChevronLeft className={cn("size-4", className)} {...props} />
        ),
        IconRight: ({ className, ...props }: { className?: string, props: React.ComponentProps<typeof ChevronRight> }) => (
