    ...
    return (
      <section className="bg-white rounded-lg p-6 flex flex-col gap-8">
        ...
        {checkboxes.map(({ id, label }) => (
          <div key={id} className="px-8 py-4 rounded-lg bg-default-background mb-6">
        ...
        <Button className="text-bold text-[1rem] bg-primary-500 text-white rounded-lg py-4 px-8 h-fit hover:bg-primary-600 self-start">
          Rent Now
        </Button>
        <div className="flex flex-col gap-4">
          <Image src="/Safety.png" alt="safety" width={32} height={32} />
          <div className="flex flex-col gap-2">
            <h4 className="text-[1rem] font-semibold text-secondary-500">
